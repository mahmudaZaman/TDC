...
data_dir = pathlib.Path("dataset/Mushrooms/") # turn our training path into a Python path
class_names = np.array(sorted([item.name for item in data_dir.glob('*')])) # created a list of class_names from the subdirectories
num_of_classes = len(class_names)
print(class_names, num_of_classes)

num_images_train = len(os.listdir("dataset/Mushrooms/Boletus"))
print(num_images_train)

img = view_random_image(target_dir="dataset/Mushrooms/",
                        target_class="Boletus")
...
valid_data = tf.keras.preprocessing.image_dataset_from_directory(data_dir,
                                               validation_split=0.2,
                                               subset="validation",
                                               seed=123,
                                               batch_size=32,
...
model.save("out/mushroom_model.h5")
