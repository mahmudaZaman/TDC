...
(train_data, test_data), ds_info = tfds.load(name="beans", # target dataset to get from TFDS
...
model = tf.keras.Sequential([
  tf.keras.layers.Conv2D(filters=16,input_shape=(224,224,3), kernel_size=5, padding='same', activation='relu'),
